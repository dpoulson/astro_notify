...
?>
<head>
<title><?php echo $config->site_name ?> - Terms and Conditions</title>
</head>

<body>
<h3>Data Protection Policy: <?php echo $config->site_name ?></h3>
<h4>1) Definitions</h4>
<ol>
...
<ol>
<li>Overall and final responsibility for data protection lies with the site owner, who is responsible for overseeing activities and ensuring this policy is upheld.</li>
<li>All volunteers are responsible for observing this policy, and related procedures, in all areas of their work for the site.</li>
</ol>
<h4>3) Overall policy statement</h4>
<ol>
<li>The <?php echo $config->site_name ?> site needs to keep minimal personal data about its users.</li>
...
<hr />
<h3><?php $config->site_name ?> - Data protection procedures</h3>
<h4>1) Introduction</h4>
<ol>
<li><?php echo $config->site_name ?> site has a data protection policy which is reviewed regularly. In order to help us uphold the policy, we have created the following procedures which outline ways in which we collect, store, use, amend, share, destroy and delete personal data.</li>
